...
#define DECOUPLING_TEST_MAX_HOLD_VARIANCE 40 //  20 Firmware tests for decoupled sensor - heater. When target temperature is reached, the temperature may only swing this amount or it will mark your combination as decoupled. If you get false alarams after reaching target temperature, increase this value.
#define DECOUPLING_TEST_MIN_TEMP_RISE 1 //1
...
#define EXT0_DECOUPLE_TEST_PERIOD 12000  //  12000
...
#define PID_CONTROL_RANGE 20  //20
...
#define UI_PRINTER_NAME "TRONXY X1"
